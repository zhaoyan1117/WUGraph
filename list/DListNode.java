...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    DListNode newAfter = myDList.newNode(item, myDList, this, next);
    newAfter.prev.next = newAfter;
    newAfter.next.prev = newAfter;
    myDList.size++;
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   new node.
    DList myDList = (DList) myList;
    DListNode newBefore = myDList.newNode(item, myDList, prev, this);
    newBefore.prev.next = newBefore;
    newBefore.next.prev = newBefore;
    myDList.size++;
  }
