...
public class DList extends List {
  ...
  public void insertFront(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
	DListNode newFront = newNode(item, this, head, head.next);
	newFront.prev.next = newFront;
	newFront.next.prev = newFront;
	size++;
  }
  ...
  public void insertBack(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
	DListNode newBack = newNode(item, this, head.prev, head);
	newBack.prev.next = newBack;
	newBack.next.prev = newBack;
	size++;
  }
